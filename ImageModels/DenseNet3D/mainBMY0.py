...
if __name__ == "__main__":
    ...
    n_folds=3
    path_to_folds_csv = f'Data_stratified_split/folds-def_{n_folds}folds' # read this path
    ...
    df_merged = pd.read_csv('df_merged.csv') # read this dataset
    ...
    for fold in range(1, n_folds):
        ...
        if config_args.train:
            ...
            model = DenseNet121(spatial_dims=3, in_channels=1, out_channels=1, pretrained=False)
            model.to(device)
