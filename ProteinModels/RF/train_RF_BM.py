...
path_to_save_results = '/home/ubuntu/tenerife/data/LungAmbition/Proteinas/ResultsBaselines_BM/RandomForest'
...
name_file= "RandomForest_proteinsBM_4march25_3folds"
...
df_merged = df_merged[df_merged['GroupUpdated'].isin(['Lung_Cancer', 'IndeterminatePreLungCancer', 'Benign_Nodules', 'False_Positive'])] # include IndeterminatePreLungCancer
...
for fold in range(0, n_folds):
    ...
    # train random forest classifier, first find the best hyperparameters through a grid search cv,
    ...
    y_train_pred_prob = best_rf.predict_proba(X_train)
    ...
    if keep_false_positives_as_separate_test:
        ...
        y_false_positives_pred_prob = best_rf.predict_proba(X_false_positives)
        y_false_positives_pred = best_rf.predict(X_false_positives)
