...
path_to_save_results = '/home/ubuntu/tenerife/data/LungAmbition/Proteinas/ResultsBaselines_BMY0/RandomForest'
...
name_file= f"RF_proteins_14march25_{n_folds}folds"
...
fold_metrics_df = pd.DataFrame(columns=['Fold', 'Accuracy', 'Specificity', 'NPV', 'Precision', 'Recall', 'F1-score', 'PPV', 'AUC', 'Balanced_accuracy'])
